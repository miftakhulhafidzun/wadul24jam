  ...
  <section class="content">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title text-danger"><i class="fas fa-user-clock mr-3"></i>Belum Diproses</h3>
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title text-primary"><i class="fas fa-hourglass-half mr-3"></i>Sedang Diproses</h3>
        <div class="card-tools">
          <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
            <i class="fas fa-minus"></i>
          </button>
    ...
    <div class="card mb-auto">
      <div class="card-header">
        <h3 class="card-title text-success"><i class="fas fa-tasks mr-3"></i>Telah Diproses</h3>
        <div class="card-tools">
          <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
            <i class="fas fa-minus"></i>
          </button>
