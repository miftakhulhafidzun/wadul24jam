          ...
          <form action="" method="POST">
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="jp">Email Pelapor :</label>
                  <input type="text" name="jp" id="jp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['email']; ?>" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <label for="dp">Lokasi Kejadian :</label>
                  <input type="text" name="dp" id="dp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['lokasi']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="nb">Sosial Media :</label>
                  <input type="text" name="nb" id="nb" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['sosmed']; ?>" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-8">
                  <label for="photo">Gambar Kejadian :</label>
                  <br>
                  <img src="../assets/img/pengaduan/<?= $d['photo']; ?>" alt="gambar" style="width: 25vw;">
                </div>
              </div>
              <div class="row">
                <div class="col-md-8">
